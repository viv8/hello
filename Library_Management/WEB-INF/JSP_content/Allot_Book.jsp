...
<title>Allot Book Form</title>
<link rel="stylesheet" type="text/css" href="css_content/form_style.css">
</head>
<body>
	<form action="http://localhost:8080/Library_Management/allot_book_confirm" method="get">
		<fieldset style="border-color: black">
			<legend style="color:Black"><font size="6"><b>Allot Book</font></legend>
			<div>
				<table>
					<tr>
						<td><i/>User Id:</td>
					...
					<tr>
						<td><i/>Taken Date:</td>
						<td><input type="date" name="taken_date" placeholder="mm/dd/yyyy"></td>
					</tr>
